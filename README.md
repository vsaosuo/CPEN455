...
+ **Classification Performance**  
  ...
  - Linear scoring scale(only for the score of classification performance):  
...
+ **Report Quality**  
  ...
  - Must follow NeurIPS style guidelines

+ **Bonus Points**  
  Awarded for exceptional performance in either classification, or completion of bonus tasks
